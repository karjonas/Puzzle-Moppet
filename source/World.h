...
class World : public IWorld
{
    ...
    // All those in these sub lists are also present in the main transformables
    // list.
...
public:
    ...
    INodeHandler *AddIrrNodeHandler(scene::ISceneNode *irrNode,
                                    bool removeOnDestruct) override;

    ITransformable *AddTransform() override;

    ICharacter *AddCharacter(IMesh *mesh, s32 idAnimIdle, s32 idAnimWalk,
                             f32 height) override;
    ...
    IThirdPersonCameraController *CreateThirdPersonCameraController(
        f32 distance, f32 heightOffset, f32 minPitch, f32 maxPitch,
        f32 turnSpeed) override;
    ...
    void SetSkyBox(const core::stringc &top, const core::stringc &bottom,
                   const core::stringc &left, const core::stringc &right,
                   const core::stringc &front,
                   const core::stringc &back) override;
