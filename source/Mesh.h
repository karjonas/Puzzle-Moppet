...
struct Pass
{
    ...
    Pass(scene::IMesh *mesh)
    {
        for (u32 i = 0; i < mesh->getMeshBufferCount(); i++)
        {
            ...
            {
                materials.push_back(video::SMaterial()); // Default material.
...
public:
    ...
    void DefineAnimation(s32 id, s32 start, s32 end, f32 fps, bool looped,
                         bool interruptible, f32 transitionTime) override;
