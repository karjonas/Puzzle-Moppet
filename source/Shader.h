...
// The actual GPU shaders/materials are cached and not necessarily created with
// each Shader.
class Shader : public IShader
{
    ...
    f32 s32_As_f32(s32 value) { return *((f32 *)(&value)); }
...
public:
    ...
    void SetVertexRegisterMap(
        const LowLevelShaderRegisterMap &registerMap) override;
    void SetPixelRegisterMap(
        const LowLevelShaderRegisterMap &registerMap) override;
    ...
    void ClearFromIrrMaterial(video::SMaterial &material,
                              video::E_MATERIAL_TYPE newMaterialType) override;
