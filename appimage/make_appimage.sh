...
cd build
cmake ../.. -DCMAKE_TOOLCHAIN_FILE=$PWD/../vcpkg/scripts/buildsystems/vcpkg.cmake -DDATA_DIR=/usr/share/puzzlemoppet -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_FOR_APPIMAGE=ON
