...
public:
    ...
    // NOTE: If you are using Shaders, you should not modify the
    // MaterialTypeParam2 of a material. (it is used internally as an id for a
    // Shader object)
    virtual video::SMaterial &GetMaterial(u32 material, u16 pass = 0) = 0;

    // Set a single material to be rendered using a shader. This will overwrite
    // the material's MaterialType. Can set NULL to clear shader, this will
    // cause the material's MaterialType to be reset to video::EMT_SOLID.
