...
public:
    ...
    // Sets mass using dimensions automatically determined from some collision
    // geometry
    ...
    // Not implemented yet. I probably want to convert from Irrlicht euler
    // angles to the axis-magnitude representation used by ODE.
